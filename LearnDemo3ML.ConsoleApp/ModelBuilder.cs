...
using LearnDemo3ML.Model.DataModels;

namespace LearnDemo3ML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Administrator\Source\Repos\LearnDemo3\myMLApp\wiki-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../LearnDemo3ML.Model/MLModel.zip";
